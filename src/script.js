 ...
 * Textured Cube
 */
const texture = new THREE.TextureLoader().load( 'res/tex1.png' );
...
function quad(position, rotation, texture){
    ...
    const tex = new THREE.TextureLoader().load( 'res/tex1.png' );
...
quad(vec3(4,0,1), quat(vec3(0,1,0), 0), 'res/tex1.png');
